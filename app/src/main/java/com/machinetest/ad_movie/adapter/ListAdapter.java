...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    private final ListAdapter.ClickInterface onClickListener;

    private final List<String> _listData_id; // header titles
    // child data in format of header title, child title
    private final List<String> listData_image;

    public ListAdapter(Activity activity, List<String> listData_image,
                       List<String> _listData_id,
                       ListAdapter.ClickInterface onClickListener) {
