...
public class AdventureAdapter extends RecyclerView.Adapter<AdventureAdapter.ViewHolder> {
    ...
    private final AdventureAdapter.ClickInterface onClickListener;
    public AdventureAdapter(Activity activity, List<String> listData_image,
                            List<String> _listData_id,
                            AdventureAdapter.ClickInterface onClickListener) {
    ...
    @Override
    public void onBindViewHolder(AdventureAdapter.ViewHolder viewHolder, final int position) {
